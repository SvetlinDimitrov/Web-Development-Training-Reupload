...
public class ImportController extends BaseController {
    ...
    @Autowired
    public ImportController(PartsService partsService, TasksService tasksService, MechanicsService mechanicsService, CarsService carService) {
        this.partService = partsService;
        this.tasksService = tasksService;
        this.mechanicService = mechanicsService;
