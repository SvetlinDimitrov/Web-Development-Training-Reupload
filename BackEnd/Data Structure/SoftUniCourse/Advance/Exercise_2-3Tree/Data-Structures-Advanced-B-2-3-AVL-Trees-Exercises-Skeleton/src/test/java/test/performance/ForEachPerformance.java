...
public class ForEachPerformance extends BasePerformanceTest {
    ...
    @Test
    public void PerformanceForEach_With55500Elements() throws IllegalAccessException {
        int start1 = 0;
        int start2 = 5000;
        int start3 = 100000;
    ...
    @Category(PerformanceTests.class)
    @Test
    public void PerformanceForEach_With55500ElementsInterconnected() throws IllegalAccessException {
        int start1 = 0;
        List<Integer> elements = new ArrayList<>();
        elements.add(start1);
        Hierarchy<Integer> hierarchy = new Hierarchy<>(start1);
