...
public class ForEach extends BaseTest {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void ForEach_WithMultipleElements_ShouldIterateOverCollectionOnlyOnce() throws IllegalAccessException {
        int count = 0;
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void ForEach_WithMultipleElements_ShouldIterateThroughThemInCorrectOrder() throws IllegalAccessException {
