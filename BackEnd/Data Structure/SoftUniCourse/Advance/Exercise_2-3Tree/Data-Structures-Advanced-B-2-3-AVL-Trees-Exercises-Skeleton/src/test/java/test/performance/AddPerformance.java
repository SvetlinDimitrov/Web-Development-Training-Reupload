...
public class AddPerformance extends BasePerformanceTest {
    ...
    @Test
    public void PerformanceAdd_WithOnly2ParentWith50000SplitElements() throws IllegalAccessException {
        int count = 3;
        int counter1 = 1;
        int counter2 = 25001;
    ...
    @Category(PerformanceTests.class)
    @Test
    public void PerformanceAdd_With40000ElementsInReverseOrderIn4Groups() throws IllegalAccessException {
        int counter1 = 10000;
        int counter2 = 30000;
        int counter3 = 50000;
        int counter4 = 70000;
