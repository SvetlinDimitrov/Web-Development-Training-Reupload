...
public class GetParentPerformance extends BasePerformanceTest {
    ...
    @Test
    public void PerformanceGetParent_With50000ElementsWith1ParentInReversedOrder() throws IllegalAccessException {
    ...
    @Category(PerformanceTests.class)
    @Test
    public void PerformanceGetParent_With50000ElementsWith5000Parents() throws IllegalAccessException {
        int counter = 5001;
