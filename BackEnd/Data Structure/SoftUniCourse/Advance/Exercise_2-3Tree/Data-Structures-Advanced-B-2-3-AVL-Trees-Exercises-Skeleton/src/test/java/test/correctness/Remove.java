...
public class Remove extends BaseTest {
    ...
    public void Remove_WithNonExistantElement_ShouldThrowException() throws IllegalAccessException {
    ...
    public void Remove_WithRootElement_ShouldThrowException() throws IllegalAccessException {
        this.Hierarchy.remove(DefaultRootValue);
    }

    @Category(CorrectnessTests.class)
    @Test
    public void Remove_WithOneElement_ShouldDecreaseCountByOne() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Remove_WithElementWithChildren_ShouldDecreaseCountCorrectly() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Remove_WithElementWithNoChildren_ShouldRemoveElementCorrectly() throws IllegalAccessException {
        this.Hierarchy.add(DefaultRootValue, 2);
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Remove_WithElementWithChildren_ShouldAttachChildrenToRemovedElementsParent() throws IllegalAccessException {
        this.Hierarchy.add(DefaultRootValue, 10);
        this.Hierarchy.add(DefaultRootValue, 11);
        this.Hierarchy.add(10, 12);
        this.Hierarchy.add(10, 13);
