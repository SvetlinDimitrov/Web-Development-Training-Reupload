...
public class Add extends BaseTest {
    ...
    public void Add_WithDuplicateElement_ShouldThrowException() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test(expected = IllegalArgumentException.class)
    public void Add_ToNonExistingElement_ShouldThrowException() throws IllegalAccessException {
        this.Hierarchy.add(DefaultRootValue + 1, 2);
    }

    @Category(CorrectnessTests.class)
    @Test
    public void Add_WithSingleElement_ShouldIncrementCountByOne() throws IllegalAccessException {
        this.Hierarchy.add(DefaultRootValue, 2);
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Add_WithMultipleElements_ShouldIncrementCountCorrectly() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Add_WithSingleElement_ShouldAddCorrectElement() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Add_WithSingleElement_ShouldCorrectlySetElementsParent() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Add_WithMultipleElements_ShouldAddElementAtCorrectPlace() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Add_WithAddAfterRemoving_ShouldAddCorrectly() throws IllegalAccessException {
        this.Hierarchy.add(DefaultRootValue, 2);
