...
public class GetChildren extends BaseTest {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void GetChildren_WithAnElementWithNoChildren_ShouldReturnEmptyCollection() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void GetChildren_WithAnElementWithOneChild_ShouldReturnACollectionWithOneElement() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void GetChildren_WithAnElementWithMultipleChildren_ShouldReturnACorrectCollection() throws IllegalAccessException {
