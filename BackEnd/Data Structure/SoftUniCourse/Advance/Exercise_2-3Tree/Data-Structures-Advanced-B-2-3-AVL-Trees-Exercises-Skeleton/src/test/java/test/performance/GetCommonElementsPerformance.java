...
public class GetCommonElementsPerformance extends BasePerformanceTest {
    ...
    @Test
    public void PerformanceGetCommonElements_WithNoCommonElements() throws IllegalAccessException {
        int start1 = 0;
        int start2 = 100000;
    ...
    @Category(PerformanceTests.class)
    @Test
    public void PerformanceGetCommonElements_WithHalfCommonElementsInBothCollections() throws IllegalAccessException {
        int start1 = 0;
        int start2 = 75000;
        Hierarchy<Integer> hierarchy = new Hierarchy<>(start1);
        Hierarchy<Integer> hierarchy2 = new Hierarchy<>(start2);
