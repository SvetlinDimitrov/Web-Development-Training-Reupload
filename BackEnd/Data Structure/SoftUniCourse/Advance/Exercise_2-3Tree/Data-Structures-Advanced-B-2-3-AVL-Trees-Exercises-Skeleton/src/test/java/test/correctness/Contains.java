...
public class Contains extends BaseTest {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Contains_WithMultipleSearchesForASingleElement_ShouldReturnConsistentResult() throws IllegalAccessException {
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Contains_WithBothExistingAndNonexsitantElements_ShouldReturnCorrectResults() throws IllegalAccessException {
        this.Hierarchy.add(DefaultRootValue, 666);
    ...
    @Category(CorrectnessTests.class)
    @Test
    public void Contains_WithAnExistingElementWithMultipleElements_ShouldReturnTrue() throws IllegalAccessException {
