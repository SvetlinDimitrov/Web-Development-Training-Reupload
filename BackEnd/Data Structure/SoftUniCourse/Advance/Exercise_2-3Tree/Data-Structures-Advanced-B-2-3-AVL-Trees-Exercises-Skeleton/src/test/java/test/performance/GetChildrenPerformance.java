...
public class GetChildrenPerformance extends BasePerformanceTest {
    ...
    @Test
    public void PerformanceGetChildren_With1ElementWith50000ChildrenInReversedOrder() throws IllegalAccessException {
    ...
    @Category(PerformanceTests.class)
    @Test
    public void PerformanceGetChildren_With50000ElementsWith5000Parents() throws IllegalAccessException {
        int counter = 5001;
